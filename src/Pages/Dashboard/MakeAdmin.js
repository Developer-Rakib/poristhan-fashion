                    ...
                    <tbody>
                        {
                            users?.data?.map((user, i) => {
                                ...
                                return (
                                    <tr key={user._id} className="border-b dark:bg-gray-800 dark:border-gray-700 odd:bg-white even:bg-gray-50 odd:dark:bg-gray-800 even:dark:bg-gray-700">
                                        ...
                                        <td
                                            className="py-2 text-[13px] sm:py-4 text-center">
                                            {
                                                user?.roll !== 'admin' && <button
                                                    onClick={makeAdmin}
                                                    className="h-5 sm:h-6  sm:px-3 uppercase bg-green-400 border-none hover:bg-green-600 rounded-full text-white">Make Admin</button>
                                            }
                                        </td>
                                        <td
                                            onClick={deleteAdmin} className="py-2 text-[13px] sm:py-4 text-center">
                                            <button className="h-5 sm:h-6  sm:px-3 uppercase bg-red-500 border-none  hover:bg-red-800 rounded-full text-white">Delete Admin</button>
                                        </td>
                                    </tr>
                                )
                            })
