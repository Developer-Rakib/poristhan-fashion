            ...
            <div style={{ backgroundImage: 'url("https://dlcdnimgs.asus.com/websites/global/products/eZwnQPTSRcn68Lwd/img/kv/OPTIMIZATION_banner.jpg")', fontFamily: 'Oswald' }} className='h-[300px] sm:h-[400px] bg-center bg-cover mb-16 w-full px-2 rounded-md sm:rounded-none sm:px-0  flex justify-center items-center text-white Container'>
                <div>
                    ...
                    <form onSubmit={handleSubmit} style={{ fontFamily: 'Open Sans,sans-serif' }} >
                        ...
                        <button type='submit' style={{ fontFamily: 'Open Sans, sans-serif', letterSpacing: '2px' }} className="hover:bg-white transition w-32 sm:w-32 mx-auto text-center bg-primary  hover:text-black rounded-r-full text-white border-2 border-primary py-1.5 sm:py-2.5">Subscribe</button>
                    </form>
                </div>
            </div>
        </div>
