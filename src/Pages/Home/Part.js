    ...
    return (
        <div  className='w-[350px] border hover:shadow-2xl transition text-secondary px-2 py-5 m-8 rounded'>
            ...
            onClick={()=>navigate(`/purchase/${_id}`)}
             style={{fontFamily:'Open Sans, sans-serif', letterSpacing:'2px'}} className="hover:bg-primary transition hover:text-white rounded-full text-primary border border-primary px-8 sm:px-10 py-1.5 sm:py-2">Buy Now</button>
        </div>
    );
};
